# ADR-0005: Three-layer precedence for fitting visibility
...
Slots have a base visibility (exposed / concealed) as part of the ship layout (see ADR-0004), used to decide what an opponent can see when scouting a ghost snapshot before battle. Two refinements came up:
