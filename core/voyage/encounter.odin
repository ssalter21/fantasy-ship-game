...
// the player's hold exactly like a Reward (voyage_apply_reward). A fled opponent and
...
// voyage_trade_grant applies a trade's gain. Gaining Hull is a repair and so caps at
...
// voyage_apply_reward pays a Reward stage's cargo into the ship's hold (issues
// #132, #133).
//
